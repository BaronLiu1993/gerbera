...
class MovementRuntime:
    ...
    def get_movement_context(self) -> dict[str, object]:
        movement_context = {}

        for movement_system_name in self.list_movement_systems():
            registry = self.movement_system_registry[movement_system_name]
            ...
            for joint in movement_system.joints:
                ...
                joint_context: dict[str, object] = {
                    ...
                    "parent_to_joint_rpy_rad": list(
                        joint.parent_to_joint_rpy_rad
                    ),
                    "description": joint.description,
                    "current_position": registry.joint_positions.get(
                        joint.name
                    ),
                }
                ...
                if isinstance(
                    ...
                    joint_context["motor_connection"] = (
                        joint.motor_connection.name
                    )
            ...
            movement_context[movement_system_name] = {

...
- `xmin` and `ymin` are the left and top edges of the object.
- `xmax` and `ymax` are the right and bottom edges of the object.
- Every box must satisfy `0.0 <= xmin < xmax <= 1.0` and
  `0.0 <= ymin < ymax <= 1.0`.
